...
func TestRangeStatsComputation(t *testing.T) {
	...
	expMS := engine.MVCCStats{LiveBytes: 25, KeyBytes: 14, ValBytes: 11, IntentBytes: 0, LiveCount: 1, KeyCount: 1, ValCount: 1, IntentCount: 0, IntentAge: 0, GCBytesAge: 0, SysBytes: 53, SysCount: 1, LastUpdateNanos: 0}
	...
	expMS = engine.MVCCStats{LiveBytes: 116, KeyBytes: 28, ValBytes: 88, IntentBytes: 23, LiveCount: 2, KeyCount: 2, ValCount: 2, IntentCount: 1, IntentAge: 0, GCBytesAge: 0, SysBytes: 53, SysCount: 1, LastUpdateNanos: 0}
	verifyRangeStats(tc.engine, tc.rng.Desc().RangeID, expMS, t)
	...
	expMS = engine.MVCCStats{LiveBytes: 50, KeyBytes: 28, ValBytes: 22, IntentBytes: 0, LiveCount: 2, KeyCount: 2, ValCount: 2, IntentCount: 0, IntentAge: 0, GCBytesAge: 0, SysBytes: 53, SysCount: 1, LastUpdateNanos: 0}
	verifyRangeStats(tc.engine, tc.rng.Desc().RangeID, expMS, t)
	...
	expMS = engine.MVCCStats{LiveBytes: 25, KeyBytes: 40, ValBytes: 22, IntentBytes: 0, LiveCount: 1, KeyCount: 2, ValCount: 3, IntentCount: 0, IntentAge: 0, GCBytesAge: 0, SysBytes: 53, SysCount: 1, LastUpdateNanos: 0}
	verifyRangeStats(tc.engine, tc.rng.Desc().RangeID, expMS, t)
}
